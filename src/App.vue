  ...
  <div class="container-fluid bg-dark py-2 d-none d-md-flex">
    <div class="container">
      <div class="d-flex justify-content-between topbar">
        <div class="top-info">
          <small class="me-3 text-white-50"><a><i class="fas fa-map-marker-alt me-2 text-white"></i></a>1127 W Main street
            Jefferson city mo</small>
          <small class="me-3 text-white-50"><a><i class="fas fa-envelope me-2 text-white"></i></a>info@3dconsultingllc.org</small>
        </div>
    ...
    <div class="container pt-5 pb-4">
      <div class="row g-5">
        <div class="col-lg-4 col-md-6">
          <a href="">
            <h1 class="text-white fw-bold d-block">3D Consulting<span class="my-text"> LLC</span> </h1>
          </a>
        ...
        <div class="col-lg-4 col-md-6">
          ...
          <div class="text-white mt-4 d-flex flex-column contact-link">
            <a class="pb-3 text-light border-bottom border-primary"><i class="fas fa-map-marker-alt text-muted me-2"></i> 1127 W Main street Jefferson city mo</a>
            <a href="tel:+15514145036" class="py-3 text-light border-bottom border-primary"><i class="fas fa-phone-alt text-muted me-2"></i> 551-414-5036</a>
            <a class="py-3 text-light border-bottom border-primary"><i class="fas fa-envelope text-muted me-2"></i> info@3dconsultingllc.org</a>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-6 text-center text-md-start">
          <span class="text-light"><a href="#" class="text-primary"><i class="fas fa-copyright text-muted me-2"></i>3D Consulting LLC</a>, All right reserved.</span>
        </div>
